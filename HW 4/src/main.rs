...
fn main() -> () {
    ...
    let r1 = test_expr(
        3.0,
        ex::Plus(Box::new(ex::Numeral(1)), Box::new(ex::Numeral(2))),
        Some(tp::Number),
    );
    let r2 = test_expr(
        3.0,
        ex::Let(
            Box::new(dc::VarDefn(
                "x".to_string(),
                Box::new(ex::Plus(Box::new(ex::Numeral(1)), Box::new(ex::Numeral(2)))),
            )),
            Box::new(ex::Minus(
                Box::new(ex::Id("x".to_string())),
                Box::new(ex::Numeral(3)),
            )),
        ),
        Some(tp::Number),
    );
    let r3 = test_expr(
        3.0,
        ex::Plus(Box::new(ex::Numeral(12)), Box::new(ex::True)),
        None,
    );
    let r4 = test_expr(
        3.0,
        ex::Times(
            Box::new(ex::StringLiteral("UwU".to_string())),
            Box::new(ex::Numeral(12)),
        ),
        None,
    );
    ...
    let r14 = test_expr(
        3.0,
        ex::Compare(
            Box::new(ex::StringLiteral("nya".to_string())),
            cmp::NotEqual,
            Box::new(ex::Numeral(0)),
        ),
        None,
    ...
    let r15 = test_expr(
        3.0,
        ex::Compare(Box::new(ex::Numeral(0)), cmp::NotEqual, Box::new(ex::True)),
        None,
    );
    ...
    let r16 = test_expr(
        ...
        ex::Let(
            ...
            Box::new(ex::Call("f".to_string(), vec![])),
        ),
        Some(tp::Boolean),
    );
    ...
    let r18 = test_expr(
        ...
        ex::Let(
            Box::new(dc::FunDefn(
                "ssqr".to_string(),
                vec![("x".to_string(), tp::Number), ("y".to_string(), tp::Number)],
                tp::Number,
                Box::new(ex::Plus(
                    Box::new(ex::Times(
                        Box::new(ex::Id("x".to_string())),
    ...
    let r19 = test_expr(
        ...
        ex::Let(
            Box::new(dc::FunDefn(
                ...
                vec![(
                    "y".to_string(),
                    tp::Function(vec![tp::Boolean], Box::new(tp::String)),
                )],
                tp::Number,
                Box::new(ex::Call("f".to_string(), vec![ex::Id("y".to_string())])),
            )),
            Box::new(ex::Numeral(3)),
        ),
        Some(tp::Number),
    ...
    let r20 = test_expr(
        ...
        ex::Let(
            Box::new(dc::FunDefn(
                ...
                tp::String,
                Box::new(ex::Compare(
                    Box::new(ex::StringLiteral("hi".to_string())),
                    cmp::Less,
                    Box::new(ex::True),
                )),
            )),
    ...
    let r21 = test_expr(
        ...
        ex::Let(
            ...
            Box::new(ex::Call("ssqr".to_string(), vec![ex::Numeral(1)])),
        ),
        None,
    );
    ...
    let r22 = test_expr(
        ...
        ex::Let(
            ...
            Box::new(ex::Call(
                "ssqr".to_string(),
                vec![ex::Numeral(1), ex::Numeral(2), ex::Numeral(3)],
            )),
        ),
        None,
    );
    ...
    let r23 = test_expr(
        ...
        ex::Let(
            Box::new(dc::FunDefn(
                ...
                tp::Boolean,
                Box::new(ex::Call("f".to_string(), vec![ex::True])),
            )),
            Box::new(ex::Call("f".to_string(), vec![ex::True])),
        ),
        None,
    ...
    let r25 = test_defn(
        ...
        dc::FunDefn(
            "f".to_string(),
            vec![("h".to_string(), tp::Number)],
            tp::Boolean,
            Box::new(ex::Compare(
                Box::new(ex::Id("h".to_string())),
                cmp::Greater,
                Box::new(ex::Numeral(0)),
            )),
        ),
        Some((
            "f".to_string(),
            tp::Function(vec![tp::Number], Box::new(tp::Boolean)),
        )),
    );
